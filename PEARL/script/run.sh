...
dataset_name=${1}
num_keywords=${2} # how many keywords in one doc
niter=${3}  # Gibbs iterate times

python ./PEARL/pyy/pearl.py --dataset-name $dataset_name --datasets-dir "./data/" --num-keywords ${num_keywords} --niter ${niter}
...
data_dir=./data/${dataset_name}/info_${niter}_${num_keywords}/
...
python ./PEARL/pyy/evaluation.py --dataset $dataset_name --class-num $K --E $E --num_keywords ${num_keywords} --niter ${niter}